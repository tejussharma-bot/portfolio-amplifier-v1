...
`;
      ...
      // Also open Behance in a new tab for convenience
      window.open('https://www.behance.net/gallery/new', '_blank');

      setFeedback({
        tone: "success",
        title: "Behance export template copied and Behance opened",
        body: "Template copied to clipboard and Behance project editor opened in new tab. Paste the content and add your visuals."
      });
    } catch (error: any) {
      setFeedback({
        tone: "error",
